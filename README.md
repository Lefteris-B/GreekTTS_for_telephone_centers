...
- **Orpheus base model** (unsloth/orpheus-3b-0.1-ft): inherits Llama 3 Community License from Meta's Llama-3.2-3B-Instruct
- **SNAC vocoder** (hubertsiuzdak/snac_24khz): MIT

The Llama 3 Community License has its own conditions (most notably an acceptable use policy and a 700M monthly-active-user threshold for commercial restrictions). For government use this is generally workable, but verify the current license text on the Meta and Hugging Face model cards before deploying.

---

## GDPR / Greek law for outbound calls

This tool only generates audio. The legal obligations (consent, the
Article 11 opt-out registry, time-of-day restrictions, in-call opt-out,
audit logging) are the responsibility of the calling system and your
operational policies. Make sure those are in place *before* you start dialing.
